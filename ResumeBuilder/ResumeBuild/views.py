...
def home(request):
    ...
    if request.method == "POST":
        ...
        template_loc = "static/images/ResumeSite.jpg"
        ...
        # Drawing Name ----------------------------------------------------------
        xCrnt, yCrnt = drawtext(data['name'], 50, 35, 41, 30, (0, 0, 0), path="fonts/Righteous-Regular.ttf")
...
def drawtext(text,size,nwords,x,y, fontcolor, print=0,path='arial.ttf'):
    ...
    if print:
        ...
        gmail_subject = 'Resume: By Shamsher Singh Chauhan'
        gmail_content = """
Hello <name>, 
